...
class MySchedule:
    ...
    def create_table(self):
        ...
        sstr = "CREATE TABLE IF NOT EXISTS " + self.table_name + "(user_name  varchar(50), title varchar(50), do_date datetime, due_date datetime, detail varchar(500), diffculty int, PRIMARY KEY(user_name, title, do_date))"
